      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 lg:pt-4">
          <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
            ...
            <p>
              Moin Consultancy works toward building long-term relationships
              with organizations across different industries and international
              markets. Our partnership-driven approach enables us to bring
              together global expertise, local knowledge, technology, talent,
              and opportunities.
            </p>

            <p>
              We aim to create an ecosystem where businesses can access the
              right solutions, institutions can build meaningful collaborations,
              professionals can discover new opportunities, and students can
              develop pathways toward successful careers.
            </p>
